    ...
    <head>
        ...
        <style>
            body {
                ...
                background: url('bgdoctor.jpg') no-repeat center center fixed;
    ...
    <body>
        <div class="container">
            <div class="menu">
                ...
                <ul>
                    <li><a href="updatedoctorprofile.jsp?loginID=<%= loginID %>">Update Doctor Profile</a></li>
                    <li><a href="changepassword.jsp">Change Password</a></li>
                    <li><a href="treatmentandprescription.jsp">Treatment and Prescription Menu</a></li>
