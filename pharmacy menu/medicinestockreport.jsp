...
<html>
    ...
    <body>
        <%
            ...
            try {
               ...
               conn = DriverManager.getConnection("jdbc:mysql://localhost/sql_mrafiq", "sql_mrafiq", "yDB5npdN8jXaZpL8");
                ...
                String sql = "SELECT medication_Code, medication_Name, stockMedication_Quantity " +
                             "FROM medication " +
        ...
        <div class="report-container">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><%= rs.getInt("stockMedication_Quantity") %></td>
                </tr>
                <%
                        }
                %>
        ...
        <%
                ...
                e.printStackTrace();
                out.println("<p>Error retrieving medicine stock report: " + e.getMessage() + "</p>");
            } finally {
